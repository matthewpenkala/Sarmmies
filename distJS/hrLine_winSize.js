...
$(window).resize(function () {
  ...
  for (
    var i = 0;
    i < parseFloat(fontCalc_winSize * 1.5) - 1 - 10 / 1.5 + 5;
    i++
  ) {
    newMessage += message;
  }
...
console.log(
  ...
  {
    "[ \u{192}":
      "\u{1D675}\u{1D69E}\u{1D697}\u{1D68C}\u{1D69D}\u{1D692}\u{1D698}\u{1D697}() { \u{2026} } \u{00A0} \u{1D608}\u{1D615}\u{1D60B}/\u{1D616}\u{1D619} \u{00A0} \u{1D68C}\u{1D698}\u{1D696}\u{1D696}\u{1D68A}\u{1D697}\u{1D68D} / \u{1D695}\u{1D698}\u{1D690} / \u{1D68D}\u{1D68E}\u{1D68B}\u{1D69E}\u{1D690} / \u{1D68E}\u{1D69D}\u{1D68C}\u{1D68E}\u{1D69D}\u{1D68E}\u{1D69B}\u{1D68A} ]"
  },
  "\n",
