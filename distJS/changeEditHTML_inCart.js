...
$("#snipcart").find("*").addBack().add("a.cart-button[href]").not("head").add(".snipcart-checkout, .w-commerce-commercecartopenlink").not("script, style").add('input[class*="add"][data-node-type*=commerce-add-to-cart-button]').click(function() {
    ...
    $("button[class*='snipcart']").contents("*").addBack().not("ul, li").click(function(){setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},9),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},99),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},499),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},999),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},2499),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},4999),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},7499),setTimeout(()=>{$.getScript("https://matthewpenkala.github.io/Sarmmies/distJS/reorderShippingRates.js")},9999)});
